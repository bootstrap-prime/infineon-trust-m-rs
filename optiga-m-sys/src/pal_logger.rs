...
#[no_mangle]
pub extern "C" fn pal_logger_init(_p_logger_context: *mut c_void) -> pal_status_t {
    // placeholder, this is accomplished by defmt
    PAL_STATUS_SUCCESS.into()
}

#[no_mangle]
pub extern "C" fn pal_logger_deinit(_p_logger_context: *mut c_void) -> pal_status_t {
    // placeholder, this is accomplished by defmt
    PAL_STATUS_SUCCESS.into()
}

#[no_mangle]
pub extern "C" fn pal_logger_read(
...
#[no_mangle]
pub extern "C" fn pal_logger_write(
    _p_logger_context: *mut c_void,
    p_log_data: *const u8,
    log_data_length: u32,
) -> pal_status_t {
